...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.convo.autotvin_input_image.dat"
         "c.convo.autotvin_kernel.dat"
         "c.convo.autotvin_conv_op.dat"
         "c.convo.autotvin_out_r.dat"
         "c.convo.autotvout_conv_op.dat"
         "c.convo.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.convo.autotvout_conv_op.dat"
         "rtl.convo.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
