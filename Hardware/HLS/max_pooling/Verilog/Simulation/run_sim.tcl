...
if {[file isfile Max_Pooling.autotvin.dat]} {
	file delete -force Max_Pooling.autotvin.dat
}

if {[file isfile Max_Pooling.autotvout.dat]} {
	file delete -force Max_Pooling.autotvout.dat
}
