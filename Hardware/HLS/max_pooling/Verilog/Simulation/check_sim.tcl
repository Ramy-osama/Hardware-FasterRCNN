...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Max_Pooling.autotvin_image_r.dat"
         "c.Max_Pooling.autotvin_stride.dat"
         "c.Max_Pooling.autotvin_out_r.dat"
         "c.Max_Pooling.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Max_Pooling.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
