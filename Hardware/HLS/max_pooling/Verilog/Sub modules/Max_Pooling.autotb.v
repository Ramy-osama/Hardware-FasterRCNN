...
`define AUTOTB_DUT      Max_Pooling
`define AUTOTB_DUT_INST AESL_inst_Max_Pooling
`define AUTOTB_TOP      apatb_Max_Pooling_top
`define AUTOTB_LAT_RESULT_FILE "Max_Pooling.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Max_Pooling.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Max_Pooling_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_MEM_image_r AESL_automem_image_r
`define AESL_MEM_INST_image_r mem_inst_image_r
`define AESL_DEPTH_stride 1
`define AESL_MEM_out_r AESL_automem_out_r
`define AESL_MEM_INST_out_r mem_inst_out_r
`define AUTOTB_TVIN_image_r  "../tv/cdatafile/c.Max_Pooling.autotvin_image_r.dat"
`define AUTOTB_TVIN_stride  "../tv/cdatafile/c.Max_Pooling.autotvin_stride.dat"
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.Max_Pooling.autotvin_out_r.dat"
`define AUTOTB_TVIN_image_r_out_wrapc  "../tv/rtldatafile/rtl.Max_Pooling.autotvin_image_r.dat"
`define AUTOTB_TVIN_stride_out_wrapc  "../tv/rtldatafile/rtl.Max_Pooling.autotvin_stride.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.Max_Pooling.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "../tv/cdatafile/c.Max_Pooling.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "../tv/rtldatafile/rtl.Max_Pooling.autotvout_out_r.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_image_r = 108;
parameter LENGTH_stride = 1;
parameter LENGTH_out_r = 27;
...
wire ap_idle;
wire ap_ready;
wire [6 : 0] image_r_address0;
wire  image_r_ce0;
wire [31 : 0] image_r_q0;
wire [6 : 0] image_r_address1;
wire  image_r_ce1;
...
wire    [6 : 0]    arrayimage_r_address0, arrayimage_r_address1;
...
assign arrayimage_r_address1 = image_r_address1;
assign arrayimage_r_ce1 = image_r_ce1;
assign image_r_q1 = arrayimage_r_dout1;
...
// The signal of port stride
reg [31: 0] AESL_REG_stride = 0;
assign stride = AESL_REG_stride;
initial begin : read_file_process_stride
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_stride,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_stride);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            ret = $sscanf(token, "0x%x", AESL_REG_stride);
              if (ret != 1) begin
...
reg end_stride;
reg [31:0] size_stride;
reg [31:0] size_stride_backup;
reg end_out_r;
reg [31:0] size_out_r;
