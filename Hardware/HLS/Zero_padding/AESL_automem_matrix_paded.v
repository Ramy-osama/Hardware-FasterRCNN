...
module AESL_automem_matrix_paded (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.matrixpadding.autotvin_matrix_paded.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.matrixpadding.autotvout_matrix_paded.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 7;
parameter DEPTH = 32'd 75;
parameter DLY = 0.1;
