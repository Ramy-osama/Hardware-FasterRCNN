...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/xiliinx/Vivado/2019.2/win64/tools/fpo_v7_0"

set ::env(PATH) "$::env(PATH);D:/xiliinx/Vivado/2019.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/xiliinx/Vivado/2019.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/xiliinx/Vivado/2019.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/xiliinx/Vivado/2019.2/win64/tools/dds_v6_0"
...
if {[file isfile matrixpadding.autotvin.dat]} {
	file delete -force matrixpadding.autotvin.dat
}

if {[file isfile matrixpadding.autotvout.dat]} {
	file delete -force matrixpadding.autotvout.dat
}
