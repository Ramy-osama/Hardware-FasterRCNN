...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.matrixpadding.autotvin_matrix_input.dat"
         "c.matrixpadding.autotvin_matrix_paded.dat"
         "c.matrixpadding.autotvout_matrix_paded.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.matrixpadding.autotvout_matrix_paded.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
